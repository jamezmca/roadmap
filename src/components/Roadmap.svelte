<script>
	...
	const objectives = {
		'html | CSS | GIT': {
			description:
				"HTML, CSS & GIT are at the foundation of most web development projects - so it's the perfect place to start.",
			milestones: {
				'HTML Crash Course': {
					url: 'https://www.youtube.com/watch?v=-RLKMY-cLYg&t=168s',
